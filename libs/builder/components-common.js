    ...
    properties: [
        {
            ...
            validValues: ["unset","flex-start", "flex-end", "center", "space-between", "space-around", "space-evenly"],
            data: {
                options: [{
                    value: "unset",
                    text: "unset"
            ...
            inline: false,
            inputtype: SelectInput,
            validValues: ["unset","start", "end", "center", "stretch"],
            data: {
                options: [{
                    value: "unset",
                    text: "unset"
            ...
            inline: false,
            inputtype: SelectInput,
            validValues: ["unset","flex-start", "flex-end", "center", "space-between", "space-around", "stretch"],
            data: {
                options: [{
                    value: "unset",
                    text: "unset"
